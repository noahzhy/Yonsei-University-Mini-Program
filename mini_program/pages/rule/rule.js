...
Page({
  ...
  data: {
    ...
    cooperation: "“汉阳小狮子”是为即将进入汉阳大学本科、大学院的中国留学生量身打造的微信小程序。旨在帮助即将进入汉阳大学的同学提供了解和交流有关汉阳大学的校园生活的最佳机会和平台。“汉阳小狮子”主要功能涵盖课程的评价、常见问题答疑、二手书交易。同时“汉阳小狮子”也欢迎有意共同维护以及后续进行进一步开发的优秀在韩留学生加入我们。并且如果有想要加入或开发此类小程序的在韩其他学校，也可以通过以下联系方式发送合作意愿邮件到我们的邮箱。",
